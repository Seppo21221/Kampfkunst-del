...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Tae Kwon Do
    </h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Tae Kwon Do</li>
    </ol>

     
      <h2>Was ist Tae Kwon Do?</h2>
      <img src="resources/j_t_sw4.jpg" alt="Tae Kwon Do" class="float-left mr-2 mb-2 mt-2" style="display:block;max-width: 50%; height:auto">
<p style="text-align: justify">
Taekwondo ist ein System der waffenlosen Selbstverteidigung, dessen Ursprungsland Korea ist. In der von uns unterrichteten Form, ist Taekwondo weniger Kampfsport als Kampfkunst, deren System von variationsreichen Techniken mit allen Teilen der Hände, Arme, Beine und Füße erlernt wird und die damit in erster Linie der Persönlichkeitsentfaltung des einzelnen dient. Taekwondo bedeutet wörtlich übersetzt: Weg des Fußes und der Hand.</p>

<h2>Wie wir trainieren</h2>
      <p style="text-align: justify">
