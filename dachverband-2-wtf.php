...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">World Taekwondo
    </h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">World Taekwondo</li>
    </ol>

     
      <h2>World TaeKwonDo Federation</h2>
      <img src="resources/world_tkd_logo.png" alt="world taekwondo" class="float-left mr-2 mb-2 mt-2" style="display:block;height:auto">
...
Mehr über unseren Dachverband World Taekwondo erfahren sie unter <a href="http://www.worldtaekwondo.org/">worldtaekwondo.org</a></p><br><br><br>
