...
<body>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Escrima</li>
    </ol>

     
      <h2>Was ist Escrima?</h2>
      <img src="resources/escrima.jpg" alt="Escrima" class="float-left mr-2 mb-2 mt-2" style="display:block;max-width: 40%; height:auto">
