...
<body>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">EWTO</li>
    </ol>

     
      <h2>Europäische WingTsun Organisation</h2>
      <img src="resources/ewto_head.jpg" alt="EWTO" class="float-left mr-2 mb-2 mt-2" style="display:block;max-width:40%;height:auto">
...
Mehr über unseren Dachverband EWTO erfahren sie unter <a href="https://wingtsunwelt.com/">wingtsunwelt.com</a></p><br><br><br>
